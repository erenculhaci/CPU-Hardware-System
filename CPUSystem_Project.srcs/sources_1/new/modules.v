...
(
    ...
    SequentialCounter seqCounter(Clock, Reset, SeqCtr_T);
    ...
    parameter AND = 4'd0, OR = 4'd1, NOT = 4'd2, ADD = 4'd3, SUB = 4'd4, LSR = 4'd5, LSL = 4'd6, INC = 4'd7, DEC = 4'd8, BRA = 4'd9, BNE = 4'd10, MOV = 4'd11, LD = 4'd12, ST = 4'd13, PUL = 4'd14, PSH = 4'd15;
    ...
    begin
        case (SeqCtr_T)
            ...
            DECODE:
            begin
                opcode = aluSystem.IROut[15:12];
                addressingMode = aluSystem.IROut[10];
                RSel = aluSystem.IROut[9:8];
                address = aluSystem.IROut[7:0];
                dstReg = aluSystem.IROut[11:8];
                SReg1 = aluSystem.IROut[7:4];
                SReg2 = aluSystem.IROut[3:0];
            end
